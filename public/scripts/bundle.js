...
/***/ function(module, exports, __webpack_require__) {
	...
	window.initRpg = _app2.default.initRpg;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function initRpg() {
	  ReactDOM.render(React.createElement(_rpgContainer.RpgContainer, null), document.getElementById('content'));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _battleArenaView = __webpack_require__(38);
	...
	var SandboxContainer = exports.SandboxContainer = function (_Component) {
	  ...
	  function SandboxContainer() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(SandboxContainer).call(this));
	  }
	
	  _createClass(SandboxContainer, [{
	    key: 'attack',
	    value: function attack(from, to) {
	      req({
	        url: '/attack',
	        method: 'post',
	    ...
	    value: function render() {
	      var pokemon = [{ name: 'pikachu', hp: 45, url: 'pikachu' }, { name: 'ditto', hp: 45, url: 'ditto' }, { name: 'clefairy', hp: 45, url: 'clefairy' }, { name: 'cloyster', hp: 45, url: 'cloyster' }, { name: 'cubone', hp: 45, url: 'cubone' }, { name: 'dewgong', hp: 45, url: 'dewgong' }, { name: 'diglett', hp: 45, url: 'diglett' }, { name: 'ditto', hp: 45, url: 'ditto' }, { name: 'dodrio', hp: 45, url: 'dodrio' }, { name: 'doduo', hp: 45, url: 'doduo' }, { name: 'dragonair', hp: 45, url: 'dragonair' }, { name: 'dragonite', hp: 45, url: 'dragonite' }, { name: 'dratini', hp: 45, url: 'dratini' }, { name: 'drowzee', hp: 45, url: 'drowzee' }, { name: 'dugtrio', hp: 45, url: 'dugtrio' }, { name: 'eevee', hp: 45, url: 'eevee' }, { name: 'ekans', hp: 45, url: 'ekans' }, { name: 'electabuzz', hp: 45, url: 'electabuzz' }, { name: 'electrode', hp: 45, url: 'electrode' }, { name: 'exeggcute', hp: 45, url: 'exeggcute' }, { name: 'exeggutor', hp: 45, url: 'exeggutor' }, { name: 'farfetchd', hp: 45, url: 'farfetchd' }, { name: 'fearow', hp: 45, url: 'fearow' }, { name: 'flareon', hp: 100, url: 'flareon' }];
	
	      var chosenForBattle = (0, _lodash.first)(pokemon);
	      var opponentChosenForBattle = (0, _lodash.last)(pokemon);
	
	      var selectedForBattle = (0, _lodash.take)(pokemon, 5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if("function"=='function'&&_typeof(__webpack_require__(5))=='object'&&__webpack_require__(5)){ // Define as an anonymous module so, through path mapping, it can be
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BattleArenaView = exports.BattleArenaView = function (_Component) {
	  ...
	  _createClass(BattleArenaView, [{
	    key: 'renderSelectedPokemon',
	    value: function renderSelectedPokemon() {
	      var _this2 = this;
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'h4',
	              null,
	              this.props.chosenForBattle.name,
	              ' (',
	              this.props.chosenForBattle.hp,
	              ' hp)'
	            ),
	            React.createElement(
	              'a',
	              { href: 'javascript:;', onClick: this.props.attack },
	              'Attack!'
	            )
	          ),
	          React.createElement(
	            ...
	            React.createElement(
	              'h4',
	              null,
	              this.props.opponentChosenForBattle.name,
	              ' (',
	              this.props.opponentChosenForBattle.hp,
	              ' hp)'
	            )
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _selectPokemonView = __webpack_require__(43);
	      ...
	      (0, _reqwest2.default)({
	        ...
	        success: (0, _lodash.bind)(function (r) {
	          _this2.setState({
	            ...
	            opponentChosenForBattle: r.chosenForBattle[_this2.state.opponentPlayerId]
	          });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.RpgContainer = undefined;
	...
	var RpgContainer = exports.RpgContainer = function (_Component) {
	  _inherits(RpgContainer, _Component);
	
	  function RpgContainer() {
	    _classCallCheck(this, RpgContainer);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RpgContainer).call(this));
	  ...
	  _createClass(RpgContainer, [{
	    ...
	    key: 'tickBattleCore',
	    value: function tickBattleCore() {
	      var _this2 = this;
	
	      var chosen = this.tickPokemon(this.state.chosen);
	      var battling = this.tickPokemon(this.state.battling);
	      var playByPlay = this.state.playByPlay;
	    ...
	    value: function isGameOver() {
	      if ((0, _lodash.get)(this.state, 'chosen.hp', 0) <= 0 || (0, _lodash.get)(this.state, 'battling.hp', 0) <= 0 || (0, _lodash.get)(this.state, 'battling.captured', false) == true) return true;
